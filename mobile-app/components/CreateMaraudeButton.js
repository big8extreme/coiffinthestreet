...
class CreateMaraudeButton extends Component {
  render() {
    const { onPress, label } = this.props;
    const { navigate } = this.props.navigation;
    return (
      <TouchableOpacity onPress={onPress} onPress={() => this.props.navigation.navigate('MaraudeForm')}>
        <Svg
          height={100}
          width={400}
        >
...
export default withNavigation(CreateMaraudeButton);
