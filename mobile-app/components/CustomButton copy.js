...
const CustomButton = ({ label='', navigation = {}, screen = "",  labelColor = '#fff', color = 'transparent', onPressFunc=null  }) => {
  ...
  return (
    ...
    style={{ ...style.btnValidate, backgroundColor: color, alignSelf:'center', bottom: 0, fontSize:fontSize}}
    activeOpacity={1}>
         <Svg
           height={100}
           width={350}
