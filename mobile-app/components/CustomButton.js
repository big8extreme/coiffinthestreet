...
const CustomButton = ({ label='', navigation = {}, screen = "",  labelColor = '#fff', color = 'transparent', onPressFunc=null, fontSize=32 , decalagetext=90 , fontColor="white", colorfill='#FDC500'}) => {
  ...
  return (
    ...
    style={{ ...customStyle.btnValidate, backgroundColor: color, alignSelf:'center', bottom: 0}}
    activeOpacity={1}>
         <Svg
           height={100}
           width={350}
